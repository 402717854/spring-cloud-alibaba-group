package com.springcloud.alibaba.demo.nacos.controller;

import com.alibaba.fastjson.JSONObject;
import com.springcloud.alibaba.demo.nacos.support.OrderProperties;
...
public class DemoController {
    ...
    public Map<String, Object> test02() {
        return new JSONObject().fluentPut("payTimeoutSeconds", payTimeoutSeconds)
                ...
                .fluentPut("commonValue",commonValue);
    }
